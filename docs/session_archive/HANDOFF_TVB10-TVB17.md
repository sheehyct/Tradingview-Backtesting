# HANDOFF archive -- sessions TVB-10 .. TVB-17 (tradingview-backtesting)

> Archived VERBATIM from docs/HANDOFF.md on 2026-08-09 (TVB-21 session end,
> user-approved) when the live file passed the 1500-line limit. Newest first.
> The live HANDOFF retains TVB-18 through the current session. This file's
> tail carries the pointer to the earlier TVB-0..TVB-9 archive.
