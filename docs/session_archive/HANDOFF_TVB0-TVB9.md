# HANDOFF archive -- sessions TVB-0 .. TVB-9 (tradingview-backtesting)

> Archived VERBATIM from docs/HANDOFF.md on 2026-07-17 (TVB-13 session end,
> user-approved) when the live file passed the 1500-line limit. Newest first.
> The live HANDOFF retains TVB-10 through the current session.
